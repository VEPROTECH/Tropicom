...
public class DemandeHistoryAdapter extends RecyclerView.Adapter<DemandeHistoryAdapter.ViewHolder> implements Filterable{
    private Context ctx;
    ...
    public DemandeHistoryAdapter(Context ctx, Activity activity, List<Annonce> annonceList){
        this.ctx=ctx;
    ...
    @Override
    public DemandeHistoryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                dialog.setButton(DialogInterface.BUTTON_POSITIVE, "OUI", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                request.supDemande(annonce.getId(), new MyRequest.ChangeCallBack() {
                                    @Override
