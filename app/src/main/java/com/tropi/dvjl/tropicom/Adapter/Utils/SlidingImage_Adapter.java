...
/**
 * Created by Verbeck DEGBESSE on 13/11/2018.
 */
...
public class SlidingImage_Adapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        Glide.with(context).load(imageModelArrayList.get(position).getImage_url())
                .into(imageView);
        //imageView.setImageURI(imageModelArrayList.get(position).getImage_url());
