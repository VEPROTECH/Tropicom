...
import com.tropi.dvjl.tropicom.Adapter.Utils.DemandeHistoryAdapter;
...
public class HistoryDemande extends AppCompatActivity {
    RecyclerView list_annonce;
    DemandeHistoryAdapter annoncesAdapter;
    TextView msg;
    Button actu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_demande);
                    ...
                    for(int i=0; i<response.length();i++){
                        try {
                            ...
                            if(images.length() > 0)
                            {
                                ...
                                annoncesAdapter=new DemandeHistoryAdapter(getApplicationContext(),HistoryDemande.this,annonces);
