...
public View.OnClickListener publier=new View.OnClickListener() {
    ...
    public void onClick(View view) {
        if(bitmap1 != null){
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    request.saveImage(img, id, new MyRequest.ChangeCallBack() {
                        @Override
                        public void onSuccess(String message) {
                            ...
                            {
                                AlertDialog alertDialog=new AlertDialog.Builder(Images.this).create();
                                alertDialog.setMessage("Publication effectuée avec succès. Ajouter d'autres images ? ");
                                alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Oui", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                       Intent intent=new Intent(Images.this,Interface.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent i=new Intent(Images.this,Interface.class);
                startActivity(i);
            finish();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST1 &&  data != null && data.getData() != null) {
            ...
            try {
                ...
                Glide.with(Images.this).loadFromMediaStore(filePath)
                        .thumbnail(0.5f)
                        .crossFade()
                        .centerCrop()
    ...
    private void showFileChooser1() {
        ...
        new AlertDialog.Builder(Images.this).setItems(str, new DialogInterface.OnClickListener() {
            @Override
    ...
    ProgressDialog prg;
    public void loading(){
        prg=new ProgressDialog(Images.this);
